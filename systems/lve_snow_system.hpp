// Vulkan学习项目 — 雪花粒子系统（精简版）
// 仅含雪花特有逻辑，共享资源由 LveParticleSystem 打包器管理
...
namespace lve
{
    ...
    {
    public:
        LveSnowSystem(LveDevice &device,
        ...
        LveSnowSystem(const LveSnowSystem &) = delete;
        LveSnowSystem &operator=(const LveSnowSystem &) = delete;
